...
> 🌩️ augment 云端同步工具和verdent云端同步工具 以及windsurf云端集成工具

---
## 🚀 windsurf使用说明
1. **更新** 获取最新的额度和token信息
2. 选择 **登录**，自动重置设备Id和登录态写入
<img width="850" height="750" alt="image" src="https://github.com/user-attachments/assets/754af54f-20d5-4e78-a5ff-734b20ff8732" />
